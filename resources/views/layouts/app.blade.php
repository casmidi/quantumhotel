...
<head>
    ...
    <style>
        ...
        body:not(.sidebar-collapse) .main-header { margin-left:340px !important; }
        .content-wrapper,
        .main-footer,
        .main-header { margin-left:340px; }
        ...
        .content-wrapper { background:radial-gradient(circle at top right, rgba(199,165,106,.12), transparent 18%), linear-gradient(180deg,#f4f7fb 0%,#edf2f8 100%); min-height:100vh; padding:1.2rem 1.35rem 1.2rem 1.7rem; margin-top:0!important; }
        .content-wrapper > h3 { display:none; }
        .content-shell { min-height:calc(100vh - 2.4rem); max-width:calc(100vw - 380px); }
        ...
        @media (max-width:991.98px){ body:not(.sidebar-collapse) .content-wrapper, body:not(.sidebar-collapse) .main-footer, body:not(.sidebar-collapse) .main-header, .content-wrapper, .main-footer, .main-header { margin-left:0 !important; } .content-wrapper { padding:.85rem; } .content-shell { max-width:none; } .sidebar-panel { border-radius:18px; } .sidebar { height:auto; } }
    </style>
</head>
